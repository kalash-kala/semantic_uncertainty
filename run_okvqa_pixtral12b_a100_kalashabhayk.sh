#!/bin/bash
# ============================================================================
# SLURM Wrapper — OK-VQA generation, pixtral-12b, A100 (kalashabhayk account)
# ============================================================================
...
#
#   sbatch run_okvqa_pixtral12b_a100_kalashabhayk.sh
# ============================================================================
#SBATCH --partition=a100
#SBATCH --gres=gpu:1
#SBATCH --job-name=okvqa_pixtral12b
...
echo "=========================================="
echo "OK-VQA generation — pixtral-12b — A100"
echo "=========================================="
