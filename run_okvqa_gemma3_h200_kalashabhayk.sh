#!/bin/bash
# ============================================================================
# SLURM Wrapper — OK-VQA generation, gemma-3-12b-it, H200 (kalashabhayk account)
# ============================================================================
# Identical to run_okvqa_gemma3_a100_kalashabhayk.sh except for the SBATCH
# resource block (H200 partition/qos). Runs the remaining OK-VQA model
# (Qwen2.5-VL already ran on the other box). Hardcoded to
...
#SBATCH --job-name=okvqa_gemma3_12b_h200
...
# A100-confirmed bs=12 (see run_okvqa_gemma3_a100_kalashabhayk.sh) scaled by
# the 1.45x VRAM-headroom multiplier measured for this exact model in
# submit_nq_all.sh ( (140-W)/(79-W), gemma3_12b: 32->46 ), floored: 12*1.45=17.
GENERATION_BATCH_SIZE=17
NUM_GENERATIONS=10
NUM_SAMPLES=14055
